...
import 'package:devsprint/presentation/home/models/user_location_result_model.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: _locationResultModel != null
              ? _buildBody()
              ...
              child: Column(
                children: [
                  Container(
                    color: Colors.black,
                    width: double.maxFinite,
                    child: Center(child: Text("Section: ${_locationResultModel!.data![index].id}", style: textThemeCustom.headlineMedium)),
                  ),

                  _buildLocationWidget(location: _locationResultModel!.data![index].weather.location),
                  SizedBox(height: 10.h),
                  _buildWeatherWidget(weather: _locationResultModel!.data![index].weather),
                  SizedBox(height: 10.h),
                  _buildPropertiesWidget(properties: _locationResultModel!.data![index].properties),
                ],
              ),
            );
          },
        ...
        ElevatedButton(
            onPressed: () async {
              if (_locationState != null) {
                ...
                if(_response != null) {
                  UserLocationResultModel _model = UserLocationResultModel.fromJson(_response.data);
                  setState(() {
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          width: double.maxFinite,
          child: Center(child: Text("Location", style: textThemeCustom.headlineMedium)),
        ),

        Text("Name: ${location.name}", style: textThemeCustom.labelLarge),
        Text("Country: ${location.country}", style: textThemeCustom.labelLarge),
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          width: double.maxFinite,
          child: Center(child: Text("Weather", style: textThemeCustom.headlineMedium)),
        ),

        Text("Condition: ${weather.current.condition}", style: textThemeCustom.labelLarge),
        Text("Air Quality: ${weather.current.airQuality}", style: textThemeCustom.labelLarge),
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          width: double.maxFinite,
          child: Center(child: Text("Properties", style: textThemeCustom.headlineMedium)),
        ),

        Text("Address: ${properties.address}", style: textThemeCustom.labelLarge),
        Text("Poi Catagories: ${properties.poiCategory}", style: textThemeCustom.labelLarge),
        // Text("Region: ${weather.current.}", style: textThemeCustom.labelLarge),
      ],
    ),
  );
